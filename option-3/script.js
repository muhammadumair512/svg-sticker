...
function startGradientEffect3() {
  ...
  startMotionHandler((x, y) => {
    ...
    gradientElements.forEach((gradientElement, index) => {
      let neonColor;
      neonColor = {
        r: Math.round(255 - normalizedX * 108), // Bright range for red
        g: Math.round(80 + normalizedY * 199), // Bright range for green
        b: Math.round(150 + normalizedX * 100), // Bright range for blue
      };
